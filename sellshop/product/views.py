...
class ProductDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['images'] = Image.objects.filter(productversion=self.kwargs.get('pk'))
        context['form'] = ReviewForm
        context['productversion'] = ProductVersion.objects.get(pk=self.kwargs.get('pk'))
        context['relatedproducts'] = ProductVersion.objects.exclude(pk=self.kwargs.get('pk'))
