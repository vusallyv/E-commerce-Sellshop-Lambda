...
class Review(BaseModel):
    ...
    product_id = models.ForeignKey(Product, on_delete=models.CASCADE) # bu commentde qalmasin
...
class Image(models.Model):
    ...
    productversion = models.ForeignKey(ProductVersion, on_delete=models.CASCADE, verbose_name="Prodcut_ID", related_name="images")
