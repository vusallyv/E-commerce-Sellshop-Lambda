    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart_id', models.ManyToManyField(related_name='Cart_Product', to='order.Cart')),
                ('product_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.product')),
                ('wishlist_id', models.ManyToManyField(related_name='Wishlist_Product', to='order.Wishlist')),
            ],
        ),
        migrations.AddField(
            model_name='product',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.product', verbose_name='Product_ID')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
